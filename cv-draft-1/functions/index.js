...
const contactMap = {
  'contactProfile': {
    ...
    text: 'Priyanka Mukherjee  \nEmail:- 121priyankamukherjee@gmail.com',
    image: {
...
// Welcome the user
  	conv.ask( "Hey! Welcome to Priyanka's resume. What do you want to know?");
...
app.intent('About', (conv, {about}) => {
	...
	conv.ask('I am Priyanka Mukherjee, a student of Arka Jain University pursuing BCA. ')
    const i="profile";
...
app.intent('Qualifications',(conv, {qualifications})=>{
	...
	conv.ask(new Suggestions('About', 'Skills', 'Qualifications','Projects','Contact','Exit'));
	  ...
	  const carousel = new Carousel({
       ...
       synonyms: ['actions', 'google', 'resume'],
       image: new Image({
